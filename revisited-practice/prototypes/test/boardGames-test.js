...
describe("Board Game Prompts", () => {
  it("should return a list of game titles for a given game type", () => {
  ...
  it("should return a list of game titles in alphabetical order for a given game type", () => {
  ...
  it("should return the details for the highest rated game for a given game type", () => {
  ...
  it("should return the average rating score for of all games for a given game type", () => {
  ...
  it("should return the average rating score for games that match the given game type and maximum players", () => {
